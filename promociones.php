  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-black mb-4">
    <div class="container">
      ...
      <form type="form" method="post">
        ...
        <div class="mb-3 text-white">
          <input type="password" class="form-control-sm" id="exampleInputPassword1" placeholder="Contraseña">
        </div>
        <button type="submit" class="btn btn-secondary btn-sm d-sm-inline-flex mx-2">Ingresar</button>
        <button type="button" href="usuario.html" target="_self" class="btn btn-secondary btn-sm d-sm-inline-flex mx-2">Registrate</button>
      </form>
    </div>
  </nav>
